...
--
-- Host: localhost
-- Generation Time: Apr 21, 2025 at 02:41 AM
...
CREATE TABLE `about_us` (
  `id` int NOT NULL,
  `team_info` text COLLATE utf8mb4_general_ci,
...
INSERT INTO `about_us` (`id`, `team_info`, `mission`) VALUES
(1, 'Your team information goes here.', 'Your mission goes here.');
